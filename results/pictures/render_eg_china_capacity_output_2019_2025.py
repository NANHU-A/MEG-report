...
def main():
    # 单位：万吨（2019-2025；其中2021-2025与PPT版数据对齐）
    years = np.arange(2019, 2026)
    capacity = np.array([1070, 1210, 2049.5, 2477.5, 2792.5, 2857.5, 2903.0])
    output = np.array([760, 822, 1237.0, 1368.7, 1678.0, 1960.0, 2100.0])
    ...
    fig.text(
        0.08,
        0.14,
        "- 中国是过去五年全球MEG产能增长核心引擎：2019年约1070万吨 -> 2024年约2858万吨。",
        fontsize=16,
        color="#1f2a33",
    )
    fig.text(
        0.08,
        0.10,
        f"- 产量从2020年822万吨增至2024年1960万吨，对应年复合增长率约{cagr_2020_2024 * 100:.1f}%。",
        fontsize=16,
        color="#1f2a33",
    )
    fig.text(
        0.08,
        0.06,
        "- 2025年延续扩产放量趋势（估算口径）：产能约2903万吨，产量约2100万吨。",
        fontsize=16,
        color="#1f2a33",
    )
