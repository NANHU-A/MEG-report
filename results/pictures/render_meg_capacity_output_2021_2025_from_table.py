...
def main():
    ...
    fig.text(0.50, 0.02, "数据来源：用户提供图片整理（2021-2025）", ha="center", fontsize=13, color="#555555")

    fig.savefig("results/pictures/eg-china-capacity-output-2021-2025-from-table.png", dpi=170, bbox_inches="tight")
    fig.savefig("results/pictures/eg-china-capacity-output-2021-2025-from-table.svg", bbox_inches="tight")
    print("saved")
